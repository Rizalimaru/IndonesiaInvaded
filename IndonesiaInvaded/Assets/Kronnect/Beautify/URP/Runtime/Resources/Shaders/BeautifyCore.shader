...
Subshader {	
  ...
  Pass { // 3
	  ...
	  #pragma multi_compile_local __ BEAUTIFY_BLOOM_USE_LAYER BEAUTIFY_BLOOM_USE_LAYER_INCLUSION
  ...
  Pass { // 17 
	  ...
	  #pragma multi_compile_local __ BEAUTIFY_ANAMORPHIC_FLARES_USE_LAYER BEAUTIFY_ANAMORPHIC_FLARES_USE_LAYER_INCLUSION
